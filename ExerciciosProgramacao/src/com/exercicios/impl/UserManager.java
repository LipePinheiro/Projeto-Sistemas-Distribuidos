...
public class UserManager {
	...
	// GET ALL USERS
		...
		public Response update(String email, String novoEmail, String password, String novaPassword, String username, String LoggedUser) {
			List<User> user = UserData.getInstance().getUser(LoggedUser);
			...
			if((password.equals(passwordUser)) && (email.equals(emailUser))) {
