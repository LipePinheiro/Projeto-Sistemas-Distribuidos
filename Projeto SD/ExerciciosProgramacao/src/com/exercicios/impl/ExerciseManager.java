...
return exerciseManager;
	...
	//Get todos os exercicios
		...
		public List<Exercise> getExercises(String pesquisa) {
			ExerciseData exerciseData = ExerciseData.getInstance();				
			return exerciseData.getData(pesquisa);
		}

		public List<Exercise> getExercisesUser(String pesquisa) {
			ExerciseData exerciseData = ExerciseData.getInstance();				
			return exerciseData.getDataUser(pesquisa);
		}
